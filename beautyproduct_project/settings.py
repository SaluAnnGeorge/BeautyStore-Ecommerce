"""
Django settings for beautyproduct_project project.
...
SECRET_KEY = 'django-insecure-dq(0x09q-zhjih!i%8z0=9psmo=+fxr6$js@mvdti72f+yq$xr'
...
ROOT_URLCONF = 'beautyproduct_project.urls'
...
WSGI_APPLICATION = 'beautyproduct_project.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'saluanngeorge@gmail.com'
EMAIL_HOST_PASSWORD = 'kulxgnhqmxssgqyh'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "DIVINE STORE",
    
    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "divine-logo.png",
    ...
    "topmenu_links": [
        ...
        {"name": "Customers", "url": "http://127.0.0.1:8000/admin/beautystore_app/customer/", "new_window": False},

        # external url that opens in a new window (Permissions can be added)
        {"name": "Products", "url": "http://127.0.0.1:8000/admin/beautystore_app/product/", "new_window": False},
...
"custom_links": {
    ...
    "site_brand": "Divine store",
    "welcome_sign": "Welcome to the AdminDashboard",
    "copyright": "Divine store ",
     "icons": {
